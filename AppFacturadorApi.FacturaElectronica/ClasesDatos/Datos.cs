...
namespace AppFacturadorApi.FacturaElectronica.ClasesDatos
{
    public class Datos
    {
        ...
        {//numeroIdentificaccion id empresa, cituacionComprobante estado factura
        ...
        {//tipo documento, sucursal, caja,fecha idFactura
